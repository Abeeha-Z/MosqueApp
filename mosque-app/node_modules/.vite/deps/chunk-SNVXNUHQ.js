...
function D(t2, e, o = true) {
  var n, r, i2, l2;
  if (t2) {
    let d3 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), s4 = d3.height, a2 = d3.width, u = e.offsetHeight, p2 = e.offsetWidth, f2 = e.getBoundingClientRect(), g4 = $2(), it = k(), lt2 = h(), L, N2, ot = "top";
...
function ce(e, t2 = {}) {
  ...
  for (; i2.length; ) {
    ...
    for (let p2 in m2) {
      let h2 = m2[p2], y2 = ke(h2), x3 = z(p2, a2) ? Q2(u) : Q2(u, ee(p2));
      if (i(y2)) i2.push({ node: y2, path: x3 });
      else {
        let k2 = ne(x3), w3 = Y2(y2, x3, s4, [a2]);
        _e(l2, k2, w3);
        let $3 = x3;
...
var S2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(t2) && r.transform !== "strict") {
    let k2 = e.replace("-directive", ""), m2 = t2, { colorScheme: w3, extend: $3, css: j } = m2, V2 = b2(m2, ["colorScheme", "extend", "css"]), u = $3 || {}, { colorScheme: D2 } = u, z3 = b2(u, ["colorScheme"]), p2 = w3 || {}, { dark: E2 } = p2, L = b2(p2, ["dark"]), h2 = D2 || {}, { dark: te } = h2, re = b2(h2, ["dark"]), K3 = s(V2) ? this._toVariables({ [k2]: d2(d2({}, V2), z3) }, r) : {}, M2 = s(L) ? this._toVariables({ [k2]: d2(d2({}, L), re) }, r) : {}, X = s(E2) ? this._toVariables({ [k2]: d2(d2({}, E2), te) }, r) : {}, [B, G2] = [(y2 = K3.declarations) != null ? y2 : "", K3.tokens || []], [I, U3] = [(N2 = M2.declarations) != null ? N2 : "", M2.tokens || []], [H, W2] = [(x3 = X.declarations) != null ? x3 : "", X.tokens || []], q2 = this.transformCSS(k2, `${B}${I}`, "light", "variable", r, o, a2, n), Z = this.transformCSS(k2, H, "dark", "variable", r, o, a2, n);
...
var g3 = { defaults: { variable: { prefix: "p", selector: ":root", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  ...
  this._theme = _2(d2({}, this.theme), { preset: e }), this._tokens = S2.createTokens(e, this.defaults), this.clearLoadedStyleNames(), R2.emit("preset:change", e), R2.emit("theme:change", this.theme);
}, getOptions() {
  return this.options;
}, setOptions(e) {
...
//# sourceMappingURL=chunk-SNVXNUHQ.js.map
