...
<template>
  <nav class="flex w-full items-center justify-center gap-5 fixed  py-7 ">
    <RouterLink class="font-bold text-[120%]" to="/">MMSI Sunday School</RouterLink>
    <RouterLink class="font-bold text-[120%]" to="/about">About</RouterLink>
